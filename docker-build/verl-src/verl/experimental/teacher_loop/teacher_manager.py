...
# --- [verl-patch] Wave 3: Add precompute_prompt_logprobs ---
...
class AsyncTeacherLLMServerManager:
    ...
    async def precompute_prompt_logprobs(
        ...
        This allows the teacher to process prompt tokens before the student
        finishes generating its response, enabling pipeline overlap.
        """
        multi_modal_data = multi_modal_data or {}
        teacher_key = self._resolve_teacher_key(routing_key)
        teacher_model_config = self.teacher_model_configs[teacher_key]
